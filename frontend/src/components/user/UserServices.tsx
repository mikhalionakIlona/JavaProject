...
import { ServiceType, PhotoService } from '../../types';
    ...
    if (!services?.length) {
        return (
            <div className="glass-card p-12 text-center">
                ...
                <p className="text-white/40">Услуги будут добавлены позже</p>
            </div>
        );
    }
                ...
                {services?.map((service) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="glass-card p-0 cursor-pointer group overflow-hidden"
